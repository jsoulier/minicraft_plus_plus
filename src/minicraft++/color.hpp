...
static constexpr int kMppColorDebugProjectileEntityPhysics = kMppColorWhite;
...
static constexpr int kMppColorDebugStairsTilePhysics = kMppColorRed;
static constexpr int kMppColorDebugFov = kMppColorRed;
static constexpr int kMppColorDebugAction = kMppColorCyan;
...
static constexpr int kMppColorArrow1 = 420;
static constexpr int kMppColorArrow2 = 111;
static constexpr int kMppColorArrow3 = 555;
static constexpr int kMppColorArrow4 = 444;
static constexpr int kMppColorArrow5 = 0;
static constexpr int kMppColorBoat1 = 0;
static constexpr int kMppColorBoat2 = 210;
static constexpr int kMppColorBoat3 = 540;
static constexpr int kMppColorBoat4 = 0;
static constexpr int kMppColorBoat5 = 0;
static constexpr int kMppColorCampfire1 = 0;
static constexpr int kMppColorCampfire2 = 111;
static constexpr int kMppColorCampfire3 = 550;
static constexpr int kMppColorCampfire4 = 530;
static constexpr int kMppColorCampfire5 = 500;
...
static constexpr int kMppColorIron2 = 222;
static constexpr int kMppColorIron3 = 333;
static constexpr int kMppColorIron4 = 444;
static constexpr int kMppColorIron5 = 555;
