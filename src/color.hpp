...
static constexpr int kMppColorSheep1 = 111;
static constexpr int kMppColorSheep2 = 222;
static constexpr int kMppColorSheep3 = 333;
static constexpr int kMppColorSheep4 = 444;
static constexpr int kMppColorSheep5 = 555;
